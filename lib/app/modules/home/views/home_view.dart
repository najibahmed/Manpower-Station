      ...
      slivers: [
            ...
            child: Column(
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: controller.serviceData.isEmpty ? _buildBannerShimmer():  CarouselSlider(
        ...
        SliverPadding(
          ...
          sliver: SliverGrid(
              ...
              delegate:
              // controller.serviceData.isEmpty
                  // ?
            // SliverChildBuilderDelegate(
                  ...
                  // :
            SliverChildBuilderDelegate(
                      childCount:controller.serviceData.isEmpty ? 6 : controller.serviceData.length,
                      (context, index) {
          ...
          Padding(
              ...
              child: Align(
                alignment: Alignment.center,
                  child: ShimmerWidget.rectangular(height:20,width: 150,))),
          SizedBox(height: 10),
        ],
      ),
    );
